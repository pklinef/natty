...
public class DateTimeGrammarTest extends AbstractGrammarTest {
  ...
  public void date_time_alternative() throws Exception {
    ...
    assertAST("10/10/2008 or 10/12/2008", "(DATE_TIME_ALTERNATIVE (DATE_TIME (AMBIGUOUS_DATE (AMBIGUOUS_VALUE 10) (AMBIGUOUS_VALUE 10) (YEAR_OF 2008))) (DATE_TIME (AMBIGUOUS_DATE (AMBIGUOUS_VALUE 10) (AMBIGUOUS_VALUE 12) (YEAR_OF 2008))))");
    assertAST("10/13/2008 or 10/15/2008", "(DATE_TIME_ALTERNATIVE (DATE_TIME (EXPLICIT_DATE (MONTH_OF_YEAR 10) (DAY_OF_MONTH 13) (YEAR_OF 2008))) (DATE_TIME (EXPLICIT_DATE (MONTH_OF_YEAR 10) (DAY_OF_MONTH 15) (YEAR_OF 2008))))");
